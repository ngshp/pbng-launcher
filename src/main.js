...
function createWindow() {
  ...
  const finalIndex = fs.existsSync(rootIndex) ? rootIndex : path.join(__dirname, '../../index.html');
  console.log('[PBNG] Loading:', finalIndex, 'Exists:', fs.existsSync(finalIndex));
  mainWindow.loadFile(finalIndex);
